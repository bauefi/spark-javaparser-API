...
public class IfNodeFinderTest {
    @Test
    public void IfNodeFinder_counts_occurences_of_IF_statements_correctly(){
        ...
        IfNodeFinder in = new IfNodeFinder(compilationUnit);
        assertTrue(in.correctAmountOfOccurrences(3));
    }
}
